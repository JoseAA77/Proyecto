...
notes = {
    ...
    "Do9": 8372.02, "Do#9": 8869.84, "Re9": 9397.26, "Re#9": 9956.06, #"Mi9": 10548.08,
    #"Fa9": 11175.30, "Fa#9": 11839.83, "Sol9": 12543.87, "Sol#9": 13289.69, "La9": 14080.00,
    #"La#9": 14917.25, "Si9": 15804.27,
...
class Buzzer_Passiu:
    def __init__(self, buzzer_pin, frequencia = 'C4'):
        self.notes = notes
        self.pin = buzzer_pin
...
#            self.frequencia = notes[frequencia]
    ...
    def nota(self, frequencia = -1): 
        if frequencia == -1:
            frequencia = self.frequencia
        elif frequencia is None:
            frequencia = notes[frequencia]
        self.Buzz.start(50)  # Duty cycle al 50%
        #print(frequencia)
