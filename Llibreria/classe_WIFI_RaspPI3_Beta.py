...
class WIFI:
    def __init__(self, raspberry_ip = '0.0.0.0', raspberry_port = 12346, esp32_ip = '192.168.4.1', esp32_port = 12345):
        ...
        self.raspberry_port = raspberry_port  # Port del servidor de la Raspberry Pi
    ...
    def WIFI_comunicacio(self, envia_missatge = ''):
        ...
        try:
            ...
            self.client_socket.send(envia_missatge.encode('utf-8'))
    ...
    def WIFI_reinicia(self, espera = 1):
        """ Reinicia el component WIFI de la placa a la Raspberry Pi3 """
    ...
    def WIFI_tanca():
        self.server_socket.close()  # Assegura't que es tanca el socket

    def WIFI_desconecta(self, espera = 1):
        """ Desconnecta el component WIFI de la placaa la Raspberry Pi3 """
        os.system("sudo nmcli dev disconnect wlan0")
        time.sleep(espera)

    def WIFI_scan(self, espera = 1):
        """ Escaneja les SCID WIFI disponibles a la Raspberry Pi3 """
        os.system("sudo nmcli dev wifi rescan")
        time.sleep(espera)


    def WIFI_conecta(self, espera = 3):
        """ Es conecta a la SCID WIFI del ESP32 a la Raspberry Pi3 """
